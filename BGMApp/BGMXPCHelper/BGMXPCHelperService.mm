...
+ (void) withBGMAppRemoteProxy:(void (^)(id))block errorHandler:(void (^)(NSError* error))errorHandler retryOnError:(BOOL)retry {
    ...
    if (!sBGMAppConnection && sBGMAppEndpoint) {
        ...
        @synchronized(self) {
            ...
            [sBGMAppConnection setRemoteObjectInterface:[NSXPCInterface interfaceWithProtocol:@protocol(NovaLINKAppXPCProtocol)]];
...
- (void) registerAsNovaLINKAppWithListenerEndpoint:(NSXPCListenerEndpoint*)endpoint reply:(void (^)(void))reply {
    ...
    DebugMsg("BGMXPCHelperService::registerAsNovaLINKAppWithListenerEndpoint: Received BGMApp listener endpoint");
...
- (void) unregisterAsNovaLINKApp {
    ...
    DebugMsg("BGMXPCHelperService::unregisterAsNovaLINKApp: Destroying connection to BGMApp");
...
- (void) startNovaLINKAppPlayThroughSyncWithReply:(void (^)(NSError*))reply forUISoundsDevice:(BOOL)isUI {
    ...
    DebugMsg("BGMXPCHelperService::startNovaLINKAppPlayThroughSyncWithReply: Waiting for BGMApp to start IO on the output device");
    ...
    DebugMsg("BGMXPCHelperService::startNovaLINKAppPlayThroughSyncWithReply: Reply to BGMDriver: %s",
