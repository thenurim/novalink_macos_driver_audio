...
@implementation NovaLINKMusicPlayerBase
...
- (instancetype) initWithMusicPlayerID:(NSUUID*)musicPlayerID
    ...
    if ((self = [super init])) {
        NSAssert(musicPlayerID, @"NovaLINKMusicPlayerBase::initWithMusicPlayerID: !musicPlayerID");
        
        NSAssert([self conformsToProtocol:@protocol(NovaLINKMusicPlayer)],
                 @"NovaLINKMusicPlayerBase::initWithMusicPlayerID: !conformsToProtocol");
...
+ (NSUUID*) makeID:(NSString*)musicPlayerIDString {
    ...
    NSAssert(musicPlayerID, @"NovaLINKMusicPlayerBase::makeID: !musicPlayerID");
    
    return (NSUUID*)musicPlayerID;
}

#pragma mark NovaLINKMusicPlayer default implementations
