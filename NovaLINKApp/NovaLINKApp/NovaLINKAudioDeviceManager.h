...
//
//  NovaLINKAudioDeviceManager.h
//  NovaLINKApp
//
//  Copyright © 2016-2018 Kyle Neideck
//
//  Manages NovaLINKDevice and the output device. Sets the system's current default device as the output
...
static const int kNovaLINKErrorCode_OutputDeviceNotFound = 1;
static const int kNovaLINKErrorCode_ReturningEarly       = 2;

@interface NovaLINKAudioDeviceManager : NSObject
...
#ifdef __cplusplus
// The virtual device published by NovaLINKDriver.
- (NovaLINKDevice) novaLINKDevice;

// The device NovaLINKApp will play audio through, making it, from the user's perspective, the system's
...
// Set the audio output device that NovaLINKApp uses.
//
...
// is running. See NovaLINKPlayThrough.
//
// Returns one of the error codes defined by this class or NovaLINKPlayThrough, or an AudioHardware error
