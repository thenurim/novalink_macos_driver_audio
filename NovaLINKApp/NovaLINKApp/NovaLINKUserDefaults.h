...
//  apply to NovaLINKApp. The others are stored by NovaLINKDriver.
//
...
@interface NovaLINKUserDefaults : NSObject
...
// The musicPlayerID (see NovaLINKMusicPlayer.h), as a string, of the music player selected by the user.
...
// device is at index 0. See NovaLINKPreferredOutputDevices.
...
// NovaLINKApp's main menu.)
@property NovaLINKStatusBarIcon statusBarIcon;
