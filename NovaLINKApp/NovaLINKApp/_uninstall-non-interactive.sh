...
#
# Removes NovaLINKApp, NovaLINKDriver and NovaLINKXPCHelper from the system immediately. Run by uninstall.sh and the Homebrew formula.
#
...
app_path="/Applications/NovaLINK Audio Passthrough.app"
driver_path="/Library/Audio/Plug-Ins/HAL/NovaLINK Audio Device.driver"
xpc_path1="/usr/local/libexec/NovaLINKXPCHelper.xpc"
xpc_path2="/Library/Application Support/NovaLINK/NovaLINKXPCHelper.xpc"
...
user_group_name="_NovaLINKXPCHelper"
...
# temp directory.
trash_dir="$(mktemp -d -t UninstalledNovaLINKFiles)/"
...
#       to offer alternatives if NovaLINK Audio Passthrough.app isn't installed to /Applications. Or we could open it with
#         open -b "com.bearisdriving.NovaLINK.App" -- delete-yourself
#       and have NovaLINK Audio Passthrough.app delete itself and close when it gets the "delete-yourself" argument. Though
