...
#ifndef NovaLINKAppUnitTests__MockAudioDevice
#define NovaLINKAppUnitTests__MockAudioDevice
...
public:
     ...
     * @throws If this device isn't a mock of NovaLINKDevice.
     */
...
#endif /* NovaLINKAppUnitTests__MockAudioDevice */
