...
//
//  NovaLINKPlayThroughRTLoggerTests.mm
...
// Unit Include
#import "NovaLINKPlayThroughRTLogger.h"
...
@interface NovaLINKPlayThroughRTLoggerTests : XCTestCase

@end

@implementation NovaLINKPlayThroughRTLoggerTests
{
    NovaLINKPlayThroughRTLogger* logger;
}

- (void) setUp {
    [super setUp];
    logger = new NovaLINKPlayThroughRTLogger;
}
