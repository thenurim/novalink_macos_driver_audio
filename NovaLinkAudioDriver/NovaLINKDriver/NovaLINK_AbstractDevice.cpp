...
NovaLINK_AbstractDevice::NovaLINK_AbstractDevice(AudioObjectID inObjectID, AudioObjectID inOwnerObjectID)
:
    NovaLINK_Object(inObjectID, kAudioDeviceClassID, kAudioObjectClassID, inOwnerObjectID)
{
}

NovaLINK_AbstractDevice::~NovaLINK_AbstractDevice()
{
}

#pragma mark Property Operations

bool    NovaLINK_AbstractDevice::HasProperty(AudioObjectID inObjectID,
                                        pid_t inClientPID,
...
bool    NovaLINK_AbstractDevice::IsPropertySettable(AudioObjectID inObjectID,
                                               pid_t inClientPID,
                                               const AudioObjectPropertyAddress& inAddress) const
{
    bool theAnswer = false;
...
UInt32    NovaLINK_AbstractDevice::GetPropertyDataSize(AudioObjectID inObjectID,
                                                  pid_t inClientPID,
...
void    NovaLINK_AbstractDevice::GetPropertyData(AudioObjectID inObjectID,
                                            pid_t inClientPID,
                                            const AudioObjectPropertyAddress& inAddress,
                                            UInt32 inQualifierDataSize,
                                            ...
                                            void* outData) const
{
    ...
    switch(inAddress.mSelector)
    {
        ...
        case kAudioDevicePropertyAvailableNominalSampleRates:
            ...
            // a required property that can't be handled by this class or its parent, NovaLINK_Object.
            //
            // See NovaLINK_Device for info about these properties.
            //
            // TODO: Write a test that checks all required properties for each subclass.
            NovaLINKAssert(false,
                      "NovaLINK_AbstractDevice::GetPropertyData: Property %u not handled in subclass",
                      inAddress.mSelector);
        ...
        case kAudioDevicePropertyTransportType:
            ...
            ThrowIf(inDataSize < sizeof(UInt32),
                    ...
                    "NovaLINK_AbstractDevice::GetPropertyData: not enough space for the return value of "
