...
//
//  See kAudioDeviceCustomPropertyDeviceAudibleState and the NovaLINKDeviceAudibleState enum in
//  NovaLINK_Types.h for more info.
//
//  Not thread-safe.
//

#ifndef NovaLINKDriver__NovaLINK_AudibleState
#define NovaLINKDriver__NovaLINK_AudibleState
...
class NovaLINK_AudibleState
{

public:
                                NovaLINK_AudibleState();
     ...
     */
    NovaLINKDeviceAudibleState       GetState() const noexcept;

    /*! Set the audible state back to kNovaLINKDeviceIsSilent and ignore all previous IO. */
    void                        Reset() noexcept;
...
private:
    NovaLINKDeviceAudibleState       mState;
...
#endif /* NovaLINKDriver__NovaLINK_AudibleState */
