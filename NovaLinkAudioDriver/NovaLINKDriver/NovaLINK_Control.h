...
#ifndef NovaLINKDriver__NovaLINK_Control
#define NovaLINKDriver__NovaLINK_Control
...
class NovaLINK_Control
:
    public NovaLINK_Object
{

protected:
                        NovaLINK_Control(AudioObjectID inObjectID,
...
#endif /* NovaLINKDriver__NovaLINK_Control */
