...
//
//  If we change NovaLINKDevice's controls list, to match the output device set in NovaLINKApp, we need to
...
//  for a short period.
//
//  Instead, NovaLINKApp temporarily enables this device and uses it to toggle the default device. This
...
#ifndef NovaLINKDriver__NovaLINK_NullDevice
#define NovaLINKDriver__NovaLINK_NullDevice
...
public:
    static NovaLINK_NullDevice&      GetInstance();
...
public:
    CFStringRef                 CopyDeviceUID() const
                                    { return CFSTR(kNovaLINKNullDeviceUID); };
...
private:
    ...
    static NovaLINK_NullDevice*      sInstance;

    #define kNullDeviceName     "NovaLINK Null Device"
...
#endif /* NovaLINKDriver__NovaLINK_NullDevice */
