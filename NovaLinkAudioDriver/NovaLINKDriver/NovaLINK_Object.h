...
#ifndef __NovaLINKDriver__NovaLINK_Object__
#define __NovaLINKDriver__NovaLINK_Object__
...
//        been changed at all so far, except to replace "SA_Object" with "NovaLINK_Object".

//==================================================================================================
//	NovaLINK_Object
//
//	This is the base class for objects managed by NovaLINK_ObjectMap. It's only job is to ensure that
...
//	that the reference count of the object is tracked and owned by the NovaLINK_ObjectMap.
//
...
//
//	It is important that a thread retain and hold a reference while it is using an NovaLINK_Object and 
//	that the reference be released promptly when the thread is finished using the object. By
//	assuming this, a NovaLINK_Object can minimize the amount of locking it needs to do. In particular,
//	purely static or invariant data can be handled without any locking at all.
//==================================================================================================

class NovaLINK_Object
{

#pragma mark Construction/Destruction
    
public:
						NovaLINK_Object(AudioObjectID inObjectID, AudioClassID inClassID, AudioClassID inBaseClassID, AudioObjectID inOwnerObjectID);
					
	virtual void		Activate();
	virtual void		Deactivate();

protected:
	virtual				~NovaLINK_Object();

private:
						NovaLINK_Object(const NovaLINK_Object&);
	NovaLINK_Object&			operator=(const NovaLINK_Object&);
...
#endif /* __NovaLINKDriver__NovaLINK_Object__ */
