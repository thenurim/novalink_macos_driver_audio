...
static const AudioServerPlugInClientInfo client1Info = {
    ...
    /* mBundleID = */ CFSTR("life.thenurim.novalinkDriver.ClientOne")
};
...
static const AudioServerPlugInClientInfo client2Info = {
    ...
    /* mProcessID = */ 222,
    /* mIsNativeEndian = */ true,
    /* mBundleID = */ CFSTR("life.thenurim.novalinkDriver.ClientTwo")
};

@interface NovaLINK_ClientsTests : XCTestCase

@end

@implementation NovaLINK_ClientsTests {
    NovaLINK_Clients* clients;
}

- (void)setUp {
    [super setUp];
    
    clients = new NovaLINK_Clients(kAudioObjectUnknown, &taskQueue);
}
